...
import Nav from "../codojo-homepage/Nav";
...
const FirstPage = ({ onNextPage }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        const response = await fetch("https://api.codojo.in/demos", {
          method: "POST",
          headers: {
  ...
  return (
    <div>
      ...
      >
        <div>
          <h1 className="text-gray-80t0 font-bold pt-32  p-4 text-xl text-center">
            Book your FREE demo<br></br> class in just
