...
//   return (
//     <div>
//       <h1>Getting started is super easy</h1>
//       <p>
//         Take a demo session for FREE and decode for yourself,<br></br>a
//         functional PC & stable internet is all you need!
//       </p>
//       <div className="">
//         <Card className="py-4">
//           <Image
...
//             <h4 className="font-bold text-large">Select course</h4>
